...
// Handle finalization (save PC file)
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['finalize'])) {
    // The PC file is already saved - just redirect to completion page
    $_SESSION['verification_complete'] = true;
    header('Location: price_change_complete.php?pcFile=' . urlencode($pcFileName));
    exit;
}
?>
<!DOCTYPE html>
